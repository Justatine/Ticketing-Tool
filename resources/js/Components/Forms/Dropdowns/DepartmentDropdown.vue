...
const selectedLabel = computed(() => {
  const selected = props.departments?.find(department => department.value === props.modelValue);
    ...
    <Dropdown align="right" width="48">
      ...
      <template #content>
        <DropdownItem
          ...
          @select="emit('update:modelValue', department.value)"
        >
          {{ department.label }}
        </DropdownItem>
      </template>
